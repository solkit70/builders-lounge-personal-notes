...
| 방향성 | 의미 |
| --- | --- |
| **Practical Build** | 이론 공부를 넘어 실제로 만들고 있는 AI 결과물을 공유 |
| **Builder for Builders** | 서로의 첫 번째 고객이 되어 사용 경험과 피드백 제공 |
| **Workflow Sharing** | AI와 협업하며 얻은 workflow, 시행착오, 도구 활용법 공유 |
| **Collective Intelligence** | Slack, Gobi Space, meeting, demo, pitch 기록을 AI가 활용 가능한 지식 자산으로 축적 |
| **Open Ecosystem** | Bellevue 지역을 출발점으로 다양한 builder, startup, creator에게 열린 커뮤니티 지향 |
