...
- 2026년 5월 7일 첫 공식 오프라인 모임을 진행했습니다.
  - GOBI Space / Desktop hands-on을 진행했습니다.
  - 투표와 논의를 거쳐 모임의 공식 명칭을 **Builders Lounge**로 확정했습니다.
- 2026년 6월 8일 2차 모임을 Bellevue City Hall에서 온/오프 하이브리드로 진행했습니다.
  - 소개된 Product
    - Sung-Jin Kim — Brain Training Board Games
    - Changsoo Park — Builders Lounge 기록 저장소
    - Minsuk Kang — Gobi Space
    - 김진영 — Washington State Leisure Map / Trails
    - 손민수 — 시스템 장애 대응 에이전트
- 2026년 7월 6일 워싱턴주 한인상공회의소와 커피챗을 진행했습니다.
  - 지역 한인 스타트업 네트워크와의 연결, 11월 프로그램 참여 가능성, 제품을 직접 사용하고 피드백하는 협력 방안을 논의했습니다.
...
| 김진영                 | AI4PKM                     | [jykim/ai4pkm-vault](https://github.com/jykim/ai4pkm-vault)                                         | 개발 중     | Beyond LLM Wiki 발표자 (CMDS, 7/2), 사이드: Washington State Leisure Map |
...
| Nate Cho            | Job Search Co-pilot        | [GitHub](https://github.com/nathanscho/jobsearch-copilot)                                           | 초기 테스트 중 | Claude Cowork Plugin 기반 취업 준비 도구, MIT 오픈소스                         |
...
| 여상호                 | —                          | —                                                                                                   | —        | 참석 시도, 사정상 불참                                                      |
| 이은석                 | —                          | —                                                                                                   | —        | TecAce 그래픽 디자이너, 7/6 KACC 커피챗 참석                                   |
